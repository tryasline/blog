...
const Profile: FC = () => {
  ...
  const onSubmit = (data: any) => {
    ...
    dispatch(fetchUpdate({ username, email, password, image }, JSON.parse(GetCookie('userToken')!)));
    ...
    <div className={classes.accountWrap}>
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <label className={classes.inputWrap}>
          ...
          />
          <div className={classes.errorName}>{errors?.avatar && <p>Невалидный адресс фотографии</p>}</div>
        </label>
